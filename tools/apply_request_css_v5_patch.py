...
CSS.write_text(
    '/* RA Lider public request page styles. Extracted without visual changes. */\n' + css + '\n',
    encoding='utf-8',
)
text = text[:start] + '<link rel="stylesheet" href="assets/public-request.css?v=1">' + text[end + len(end_tag):]
...
if text.count('assets/public-request.css?v=1') != 1:
