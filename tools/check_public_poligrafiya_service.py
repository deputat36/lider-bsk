...
checks = [
    ...
    ('stickers page uses shared v28 form', 'assets/public-lead-form.js?v=29' in stickers),
    ...
    ('working hours page uses shared v28 form', 'assets/public-lead-form.js?v=29' in working_hours),
