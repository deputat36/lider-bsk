...
checks = [
    ...
    ('handouts page uses lead form v5', 'assets/public-lead-form.js?v=30' in handouts),
    ...
    ('stickers page uses shared v28 form', 'assets/public-lead-form.js?v=30' in stickers),
    ...
    ('working hours page uses shared v28 form', 'assets/public-lead-form.js?v=30' in working_hours),
    ...
    ('form has Polygraphy option', '\"label\": \"Полиграфия\"' in (root / 'assets' / 'leader-service-catalog.js').read_text(encoding='utf-8')),
]
