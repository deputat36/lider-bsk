...
LINK = '  <link rel="stylesheet" href="assets/public-event-ads.css?v=1">'
...
if LINK in html and '<style>' not in html:
    print('Event advertising CSS migration already applied.')
    raise SystemExit(0)
...
if normalize_css(style_blocks[0]) != normalize_css(CSS.read_text(encoding='utf-8')):
    raise SystemExit('Inline CSS does not match assets/public-event-ads.css')
...
print('Event advertising CSS migration applied.')
