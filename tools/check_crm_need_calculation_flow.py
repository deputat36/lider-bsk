...
errors = []
for marker in ['Короткий бриф', 'Размер, материал и тираж', 'data-need-design-details hidden', 'data-need-installation-details hidden', 'data-action="calculate-need"', 'leader-v4:calculate-need']:
...
if 'needs.js?v=20260715-brief-1' not in html or 'needs-brief.css?v=20260715-1' not in html or 'calculations.js?v=20260715-need-prefill-2' not in html: errors.append('Missing need brief cache marker')
if errors:
