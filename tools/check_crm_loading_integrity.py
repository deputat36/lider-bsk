...
if not match:
    ...
    expected_singletons = {
        ...
        './assets/v4/calculations.js': './assets/v4/calculations.js?v=20260914-manual-zero-1',
        './assets/v4/calculations.js?v=20260717-module-singleton-1': './assets/v4/calculations.js?v=20260914-manual-zero-1',
