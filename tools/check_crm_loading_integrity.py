...
if not match:
    ...
    expected_singletons = {
        ...
        './assets/v4/calculations.js': './assets/v4/calculations.js?v=20260925-special-price-1',
        './assets/v4/calculations.js?v=20260717-module-singleton-1': './assets/v4/calculations.js?v=20260925-special-price-1',
