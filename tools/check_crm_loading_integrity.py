...
if not match:
    ...
    expected_singletons = {
        ...
        './assets/v4/calculations.js': './assets/v4/calculations.js?v=20260906-catalog-source-1',
        './assets/v4/calculations.js?v=20260717-module-singleton-1': './assets/v4/calculations.js?v=20260906-catalog-source-1',
