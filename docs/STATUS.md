...
Cloud Browser подтвердил замену явно введённых 0 ₽ на 1300 ₽ при себестоимости 1000 ₽ в новой ручной позиции. Запись не сохранялась. Исправлен существующий builder: пустая цена включает автоматику, явный ноль сохраняется как ручная цена для своей позиции, услуги и букв/цифр. Regression на реальных функциях воспроизвёл дефект до исправления и проверяет последующее repricing. Проверка исправленного UI и CI ещё не завершены. Backend и production Supabase не меняются.
