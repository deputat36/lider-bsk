...
- Staging initial/version RPC согласованы: предупреждения сохраняются, RBAC, optimistic locking, receipts и исходные версии не меняются. Полный browser E2E расширен до четырёх версий цены; runtime и cleanup проверяются перед merge.
