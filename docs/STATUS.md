...
- Model + actual typical builder regression прошли локально. Authenticated staging E2E дополнен empty-catalog/retry сценарием; его запуск/CI ещё ожидаются, runtime успех не заявлен.
