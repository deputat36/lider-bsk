...
- CRM-модуль `public-lead-audit-v1.js`: чтение `leader_public_lead_audit`, сортировку по дате, лимит 80 событий, поля `request_id`, телефон, страница, user-agent, UTM и фильтры по статусам;
