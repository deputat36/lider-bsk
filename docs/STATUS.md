...
- добавлен единый воспроизводимый транзакционный сценарий заявки, потребности, двух версий расчёта, КП и заказа;
...
- удалённый запуск остаётся заблокирован отсутствием в окружении staging DB/JWT/Auth-доступа; production не использовался и не изменялся.
