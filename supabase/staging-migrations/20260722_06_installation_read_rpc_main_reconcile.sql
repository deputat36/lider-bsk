-- STAGING ONLY.
-- Applied as 20260722202244 / staging_installation_read_rpc_main_reconcile_20260722.
-- Restores the exact read RPC source recorded on current main after an unmerged
-- experimental capability projection changed the staging fingerprint.
