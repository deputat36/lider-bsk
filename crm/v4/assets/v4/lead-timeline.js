...
function render() {
  ...
  host.innerHTML = `
    ...
    <form id="leadTimelineForm" class="v4-timeline-form">
      ...
      <label class="v4-timeline-body-label">Комментарий менеджера<textarea id="leadTimelineBody" rows="3" placeholder="Например: обсудили баннер 3x2, клиент ждёт КП в MAX, перезвонить завтра после 10:00"></textarea></label>
