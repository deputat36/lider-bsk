...
function boot() {
  ...
  document.addEventListener('click', (event) => {
    ...
    if (trace) { event.preventDefault(); traceRequestId(trace.dataset.publicLeadAuditTrace || ''); return; }
