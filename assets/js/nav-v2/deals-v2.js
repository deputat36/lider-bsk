...
async function renderDealsEntry() {
  ...
  app.innerHTML = `
    <main class="nav-v2-shell">
      <section class="card">
        <h1>Сделки</h1>
        <p class="muted">Раздел списка сделок Navigator v2 подготовлен как точка входа. Карточку сделки можно открыть по прямой ссылке с параметром <code>?id=...</code>.</p>
